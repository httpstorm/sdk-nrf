...
#define LED_R	  DEVICE_DT_GET(DT_GPIO_CTLR(LED_R_NODE, gpios))
#define LED_G	  DEVICE_DT_GET(DT_GPIO_CTLR(LED_G_NODE, gpios))
#define LED_B	  DEVICE_DT_GET(DT_GPIO_CTLR(LED_B_NODE, gpios))
#define LED_SR	  DEVICE_DT_GET(DT_GPIO_CTLR(LED_SR_NODE, gpios))
#define LED_SG	  DEVICE_DT_GET(DT_GPIO_CTLR(LED_SG_NODE, gpios))
#define LED_SB	  DEVICE_DT_GET(DT_GPIO_CTLR(LED_SB_NODE, gpios))
...
static const struct device * led_devs[] = { LED_R, LED_G, LED_B, LED_SR, LED_SG, LED_SB };
...
#define LED_COUNT (sizeof(led_devs) / sizeof(*led_devs))
...
#define BTN_0		DEVICE_DT_GET(DT_GPIO_CTLR(BTN_0_NODE, gpios))
