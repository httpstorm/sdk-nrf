...
// UART states
nrf52840_uart_state nrf52840_uart_states[NRF52840_UARTE_COUNT];

// UART instances
uart_api nrf52840_uarts[NRF52840_UARTE_COUNT];

// UART instance links used by the interrupt handler
uart_api * nrf52840_links[NRF52840_UARTE_COUNT] = { NULL };
...
nrf52840_uart_interface nrf52840_uart_interfaces[] =
{
...
#ifdef NRF52840_H
		.reg_dma = NRF_UARTE0,
		.int_number = UARTE0_UART0_IRQn + NVIC_OFFSET,
#else
#if CONFIG_BOARD_NRF9160DK_NRF9160_S || CONFIG_BOARD_THINGY91_NRF9160
		.reg_dma = NRF_UARTE0_S,
#else
		.reg_dma = NRF_UARTE0_NS,
#endif
		.int_number = SPIM0_SPIS0_TWIM0_TWIS0_UARTE0_IRQn + NVIC_OFFSET,
#endif
		.use_int = 1,
...
#ifdef NRF52840_H
		.reg_dma = NRF_UARTE1,
		.int_number = UARTE1_IRQn + NVIC_OFFSET,
#else
#if CONFIG_BOARD_NRF9160DK_NRF9160_S || CONFIG_BOARD_THINGY91_NRF9160
		.reg_dma = NRF_UARTE1_S,
#else
		.reg_dma = NRF_UARTE1_NS,
#endif
		.int_number = SPIM1_SPIS1_TWIM1_TWIS1_UARTE1_IRQn + NVIC_OFFSET,
#endif
		.use_int = 1,
		.use_dma = 1,
...
#if CONFIG_BOARD_NRF9160DK_NRF9160_NS || CONFIG_BOARD_NRF9160DK_NRF9160_S
	{
#if CONFIG_BOARD_NRF9160DK_NRF9160_S
		.reg_dma = NRF_UARTE2_S,
#else
		.reg_dma = NRF_UARTE2_NS,
#endif
		.int_number = SPIM2_SPIS2_TWIM2_TWIS2_UARTE2_IRQn + NVIC_OFFSET,
		.use_int = 1,
		.use_dma = 1,
		...
		.pin_select_dma =
		{
			.CTS = DT_PROP_OR(DT_NODELABEL(uart2), cts_pin, -1),
			.RTS = DT_PROP_OR(DT_NODELABEL(uart2), rts_pin, -1),
			.RXD = DT_PROP_OR(DT_NODELABEL(uart2), rx_pin, -1),
			.TXD = DT_PROP_OR(DT_NODELABEL(uart2), tx_pin, -1),
		},
		.baud_rate = DT_PROP_OR(DT_NODELABEL(uart2), current_speed, 115200),
		.enabled = DT_NODE_HAS_STATUS(DT_NODELABEL(uart2), okay),
		.flow_control = DT_PROP_OR(DT_NODELABEL(uart2), hw_flow_control, 0),
#else
		.pin_select_dma =
		{
			.CTS = -1,
	...
	{
#if CONFIG_BOARD_NRF9160DK_NRF9160_S
		.reg_dma = NRF_UARTE3_S,
#else
		.reg_dma = NRF_UARTE3_NS,
#endif
		.int_number = SPIM3_SPIS3_TWIM3_TWIS3_UARTE3_IRQn + NVIC_OFFSET,
		.use_int = 1,
		.use_dma = 1,
		...
		.pin_select_dma =
		{
			.CTS = DT_PROP_OR(DT_NODELABEL(uart3), cts_pin, -1),
			.RTS = DT_PROP_OR(DT_NODELABEL(uart3), rts_pin, -1),
			.RXD = DT_PROP_OR(DT_NODELABEL(uart3), rx_pin, -1),
			.TXD = DT_PROP_OR(DT_NODELABEL(uart3), tx_pin, -1),
		},
		.baud_rate = DT_PROP_OR(DT_NODELABEL(uart3), current_speed, 115200),
		.enabled = DT_NODE_HAS_STATUS(DT_NODELABEL(uart3), okay),
		.flow_control = DT_PROP_OR(DT_NODELABEL(uart3), hw_flow_control, 0),
#else
		.pin_select_dma =
		{
			.CTS = -1,
