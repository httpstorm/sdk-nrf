...
#include <arch/cm4/nrf9160/nrf9160.h>
#include <arch/cm4/nrf9160/nrf9160_bitfields.h>
#else
...
#define NRF52840_UART_ERRATA_MAX_COUNT_RX 16
...
UART_STATUS_E nrf52840_uart_recv_job(uart_api * uart);
