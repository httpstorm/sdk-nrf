...
typedef size_t(*fn_uart_send)(struct uart_api * uart, const char * msg, size_t count);
typedef size_t(*fn_uart_recv)(struct uart_api * uart, char * msg, size_t count);
